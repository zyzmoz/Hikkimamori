...
// Modificado em 21/07/2014 - Compatibilidade com ESC/POS Zyzmo[CODE]
// Modifidado em 22/07/2014 - Compatibilidade com ESCBema (Bematech)
...
TprtLang = (lngEPFX,lngESCP2,lngHPPCL,lngESCPOS,lngESCBEMA);
...
begin
  case fLang of
    ...
    lngESCPOS : SendData (#27+ '@' + #29 + #249 + #31 + #49 );
    lngHPPCL  : SendData (#27+'E'+#27+'&l2A'+#27+'&l0O'+#27+'&l6D'+#27+'(s4099T'+#27+'(s0P'+#27+'&k0S'+#27+'(s0S');
    lngESCBEMA: SendData (#29#249#32#0#27#116#8);
  end;
end;
